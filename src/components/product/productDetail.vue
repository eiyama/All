<template>
  <div style="background-color: #FFF;">
    ...
    <div>
      <div>
        <div class="div1" style="margin-top: 45px" v-show="productDetail.coverUrl==null || productDetail.coverUrl == ''">
          <img :src="defaultImg">
        </div>
        <div class="div1" style="margin-top: 45px" v-show="productDetail.coverUrl">
          <img :src="productDetail.coverUrl" width="100%" height="240px">
        </div>
        <div class="div2">
    ...
    <div class="mint-bottom" v-show="isSalesMan">
...
export default {
  ...
  mounted:function(){
    ...
    self.shareLink = domain + '#/product/detail?pid=' + pid + '&appId=' + self.appId + '&isShare=true'
